...
import type { HelmPackagePreparation, PrepareHelmPackageOptions } from './contracts.ts';
...
export function dependencyRepositories(document: ReturnType<typeof parseDocument>, file: string): Buffer {
